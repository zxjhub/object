...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="9"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>七、年度研发成果产出情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="9">&nbsp;&nbsp;&nbsp;
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="9"><font color="black"style="font-weight:bold;font-family:黑体;">表7-4-2  技术标准和工法明细表                                     单位：项</font></td>
		</tr>
		<tr height="10">
			<td colspan="9"></td>
		</tr>
          ...
          <td width="300"><font color="black"style="font-family:宋体;">下达任务单位</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">标准/工法</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">编号</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">起草单位</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">起草人</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">平台在制定中作用</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">颁布日期</font></td>
		</tr>
		  <tr height="30"align="center">
		    <td width="300"></td>
            <td width="300"></td>
