...
$.sidebarMenu($('.sidebar-menu'))
	...
	<%} %>
<form action="/Technology_innovation_system/PtmessageServlet?method=add" method="post" onsubmit="return check()">
<table  width="1000" height="130"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="4"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>平台信息维护<i class="my-icon nav-icon icon_5"></i>平台信息维护</font></td>
		</tr>
		 <tr height="4">
        </tr>
        <tr height="10">
        ...
        <td><font color="black"style="font-family:宋体;">平台编码:</font>
        <input type="hidden" class="hidden" id="username" name="username"value=<%=username%>>
        </td>
        <td><font color="black"style="font-family:宋体;">sz19980901</font></td>
        <td><font color="black"style="font-family:宋体;">平台名称:</font></td>
        <td><input type="text"id="ptmc"name="ptmc" ></td>
        </tr>
       <tr height="30" align="center">
        <td><font color="black"style="font-family:宋体;">依托单位:</font></td>
            <td> <select id="ytdw" name="ytdw" style="width:150px;">
            <option value=" "></option>
			<option value="河北省科学技术情报研究学院">河北省科学技术情报研究学院</option>
			<option value="河北省创新创业研究院">河北省创新创业研究院</option>
			<option value="河北省调研研究院">河北省调研研究院</option>
			</select>
			</td>
        </tr>
        <tr height="30" align="center">
        <td><font color="black"style="font-family:宋体;">平台级别:</font></td>
            <td> <select id="ptjb" name="ptjb" style="width:150px;">
            <option value=""></option>
        ...
        <td><font color="black"style="font-family:宋体;">平台类型:</font></td>
            <td> <select id="ptlx" name="ptlx" style="width:150px;">
            <option value=""></option>
			<option value="产业技术研究院">产业技术研究院</option>
			<option value="科研技术研究所">科研技术研究所</option>
			<option value="调研技术研究院">调研技术研究院</option>
			</select>
			</td>
        </tr>
         <tr height="30" align="center">
        <td><font color="black"style="font-family:宋体;">批准日期:</font></td>
        <td> <input type="text"id="pzrq"name="pzrq"></td>
        <td><font color="black"style="font-family:宋体;">批准文号:</font></td>
        <td><input type="text"id="pzwh"name="pzwh"></td>
        </tr>
         <tr height="60" align="center">
		 <td colspan="4">
		<input type="submit" value="保存"style="width:80px; height:25px;border-radius:3px">
		<input type="submit" value="取消"style="width:80px; height:25px;border-radius:3px">
		</td>
		</tr>
</table>
</form>
