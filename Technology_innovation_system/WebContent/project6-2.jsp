...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="9"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>六、年度研发项目情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="9">&nbsp;&nbsp;&nbsp;<input type="button" value="表6-1"style="width:100px; height:35px;border-radius:3px"onclick="window.location.href= 'http://localhost:8080/Technology_innovation_system/project.jsp'">
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="9"><font color="black"style="font-weight:bold;font-family:黑体;">表6-2 在研项目明细表  单位：万元</font></td>
		</tr>
		<tr height="10">
			<td colspan="9"></td>
		</tr>
		 <tr height="30" align="center" >
			<td width="100" ><font color="black"style="font-family:宋体;">项目来源</font></td>
			<td width="100" ><font color="black"style="font-family:宋体;">项目来源分类</font></td>
			<td width="100" ><font color="black"style="font-family:宋体;">项目编号</font></td>
			<td width="150" ><font color="black"style="font-family:宋体;">项目名称</font></td>
			<td width="100" ><font color="black"style="font-family:宋体;">计划类别</font></td>
			<td width="100" ><font color="black"style="font-family:宋体;">起始时间</font></td>
			<td width="100" ><font color="black"style="font-family:宋体;">截止时间</font></td>
			<td width="100"><font color="black"style="font-family:宋体;">项目经费金额</font></td>
			<td width="100" ><font color="black"style="font-family:宋体;">项目状态</font></td>
		</tr>
		<tr height="30" align="center" >
			<td width="100" ></td>
			<td width="100" ></td>
