...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="7"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>八、开放合作情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="7">&nbsp;&nbsp;&nbsp;
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="7"><font color="black"style="font-weight:bold;font-family:黑体;">表8-2-2  主要学术交流明细表</font></td>
		</tr>
		<tr height="10">
			<td colspan="7"></td>
		</tr>
          ...
          <td width="300"><font color="black"style="font-family:宋体;">学术交流名称</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">举办时间</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">会议内容</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">参会单位数</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">类 别</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">主办/承办</font></td>
		</tr>
		  <tr height="30"align="center">
		    <td width="100"></td>
            <td width="300"></td>
