...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="10"><font color="black"style="font-weight:bold;font-family:黑体;">表7-4-1  技术标准和工法汇总表                                     单位：项</font></td>
		</tr>
		<tr height="10">
			<td colspan="10"></td>
		</tr>
		<tr height="30"align="center">
		  <th width="300" rowspan="2"><font color="black"style="font-family:宋体;">指 标</font></th>
          <th width="300" colspan="5"><font color="black"style="font-family:宋体;">标  准</font></th>
          <th width="300" colspan="4"><font color="black"style="font-family:宋体;">工  法 </font></th>
          </tr>
		  <tr height="30"align="center">
		  <td width="300"><font color="black"style="font-family:宋体;">合 计</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">国家标准</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">行业标准</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">地方标准</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">企业标准</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">合 计</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">国家  工法</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">省级工法</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">企业工法</font></td>
		</tr>
		  <tr height="30"align="center">
		    <td width="300"><font color="black"style="font-family:宋体;">主 持</font></td>
            <td width="300"></td>
		    <td width="300"></td>
			<td width="300"></td>
			<td width="300"></td>
		 ...
		 <tr height="30"align="center">
		    <td width="300"><font color="black"style="font-family:宋体;">参 与</font></td>
            <td width="300"></td>
		    <td width="300"></td>
			<td width="300"></td>
			<td width="300"></td>
		 ...
		 <tr height="30"align="center">
		    <td width="300"><font color="black"style="font-family:宋体;">制 订</font></td>
            <td width="300"></td>
		    <td width="300"></td>
			<td width="300"></td>
			<td width="300"></td>
		 ...
		 <tr height="30"align="center">
		    <td width="300"><font color="black"style="font-family:宋体;">修 订</font></td>
            <td width="300"></td>
		    <td width="300"></td>
			<td width="300"></td>
			<td width="300"></td>
