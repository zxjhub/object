...
<body>
<form action="">
<table  width="1980" height="120"bgcolor="#c0c0c0"border="1" cellspacing="0"style="margin-left:232px">
<tr height="50">
...
<%
	...
	<%} %>
<form action="/Technology_innovation_system/PayServlet?method=add1" method="post" onsubmit="return check()">
<table  width="1000" height="350"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="12"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>五、年度经费筹集和支出情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="12">&nbsp;&nbsp;&nbsp;
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="12"><font color="black"style="font-weight:bold;font-family:黑体;">表5-3 共建单位投入和对外经营服务收入明细表                      单位：万元</font></td>
		</tr>
		<tr height="20">
			<td colspan="12"></td>
		</tr>
		<tr height="30" align="center" >
		<td width="200" colspan="7"><font color="black"style="font-family:宋体;">共建单位投入</font></td>
		<td width="200" colspan="5"><font color="black"style="font-family:宋体;">对外经营服务收入</font></td>
		</tr>
		 <tr height="30" align="center" >
           <td width="200" colspan="2"><font color="black"style="font-family:宋体;">年度运行经费</font></td>
			...
			<td width="200" rowspan="2"><font color="black"style="font-family:宋体;">科研项目（课题）经费</font></td>
			...
			<td width="200" rowspan="2"><font color="black"style="font-family:宋体;">联合研发</font></td>
			<td width="200"rowspan="2"><font color="black"style="font-family:宋体;">技术转让</font></td>
			<td width="200"rowspan="2"><font color="black"style="font-family:宋体;">技术咨询服务</font></td>
			<th width="200"rowspan="2"><font color="black"style="font-family:宋体;">小计</font></th>
		</tr>
		  <tr height="30">
		...
		<tr height="30">
         ...
         <td width="200"><input type="text" id="kyxmjf" name="kyxmjf"onkeyup="sum();"></td>
         <td width="200"><input type="text" id="qt" name="qt"onkeyup="sum();"></td>
         <td width="200"><input type="text" id="xj3" name="xj3"></td>
         <td width="200"><input type="text" id="lhyf" name="lhyf"onkeyup="sum();"></td>
         <td width="200"><input type="text" id="jszr" name="jszr"onkeyup="sum();"></td>
         <td width="200"><input type="text" id="jszxfw" name="jszxfw"onkeyup="sum();"></td>
         <td width="200"><input type="text" id="xj4" name="xj4"></td>
		</tr>
 ...
 function sum(){
		...
		var kyxmjf = document.getElementById("kyxmjf").value;
		var qt = document.getElementById("qt").value;
     document.getElementById("xj3").value=parseFloat(rygz)+parseFloat(bgfy)+parseFloat(ss)+parseFloat(yqsb)+parseFloat(kyxmjf)+parseFloat(qt);
		var lhyf = document.getElementById("lhyf").value;
		var jszr = document.getElementById("jszr").value;
		var jszxfw = document.getElementById("jszxfw").value;
		document.getElementById("xj4").value=parseFloat(lhyf)+parseFloat(jszr)+parseFloat(jszxfw);
}
		function check() {
			...
			var kyxmjf = document.getElementById("kyxmjf");
			var qt = document.getElementById("qt");
			var xj1 = document.getElementById("xj3");
			var lhyf = document.getElementById("lhyf");
			var jszr = document.getElementById("jszr");
			var jszxfw = document.getElementById("jszxfw");
			var xj2 = document.getElementById("xj4");
			//非空
			if(rygz.value == '') {
				alert('未填入人员工资');
				rygz.focus();
