...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="9"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>八、开放合作情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="9">&nbsp;&nbsp;&nbsp;
			<input type="button" value="表8-1"style="width:100px; height:35px;border-radius:3px"onclick="window.location.href= 'http://localhost:8080/Technology_innovation_system/cooperation.jsp'">
			<input type="button" value="表8-1-1"style="width:100px; height:35px;border-radius:3px"onclick="window.location.href= 'http://localhost:8080/Technology_innovation_system/cooperation8-1-1.jsp'">
			<input type="button" value="表8-1-2"style="width:100px; height:35px;border-radius:3px"onclick="window.location.href= 'http://localhost:8080/Technology_innovation_system/cooperation8-1-2.jsp'">
			<input type="button" value="表8-1-3"style="width:100px; height:35px;border-radius:3px"onclick="window.location.href= 'http://localhost:8080/Technology_innovation_system/cooperation8-1-3.jsp'">
			<input type="button" value="表8-1-4"style="width:100px; height:35px;border-radius:3px"onclick="window.location.href= 'http://localhost:8080/Technology_innovation_system/cooperation8-1-4.jsp'">
			<input type="button" value="表8-2-1"style="width:100px; height:35px;border-radius:3px"onclick="window.location.href= 'http://localhost:8080/Technology_innovation_system/cooperation8-2-1.jsp'">
			<input type="button" value="表8-2-2"style="width:100px; height:35px;border-radius:3px"onclick="window.location.href= 'http://localhost:8080/Technology_innovation_system/cooperation8-2-2.jsp'">				
			</td>
		</tr>
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="9"><font color="black"style="font-weight:bold;font-family:黑体;">表8-1-4  引进消化吸收再创新项目明细表</font></td>
		</tr>
		<tr height="10">
			<td colspan="9"></td>
		</tr>
		  <tr height="30"align="center">
		  <td width="100"><font color="black"style="font-family:宋体;">序号</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">项目名称</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">成果来源</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">成果类型</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">成果引进金额(万元)</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">消化吸收再创新投资(万元)</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">起始时间</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">截止时间</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">是否完成</font></td>
		</tr>
		  <tr height="30"align="center">
		    <td width="100"></td>
            <td width="300"></td>
