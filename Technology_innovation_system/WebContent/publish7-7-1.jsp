...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="5"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>七、年度研发成果产出情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="5">&nbsp;&nbsp;&nbsp;
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="5"><font color="black"style="font-weight:bold;font-family:黑体;">表7-6-2  获得的重要科学技术奖项列表</font></td>
		</tr>
		<tr height="10">
			<td colspan="5"></td>
		</tr>
		  <tr height="30"align="center">
		  <td width="100"><font color="black"style="font-family:宋体;">指  标</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">合计</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">转化应用的新技术</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">转化应用的新工艺</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">产业化的新产品</font></td>

		</tr>
		  <tr height="30"align="center">
		   <td width="100"><font color="black"style="font-family:宋体;">项目数</font></td>
            <td width="300"></td>
		    <td width="300"></td>
			<td width="300"></td>
			<td width="300"></td>
			  ...
			  <tr height="30"align="center">
		   <td width="100"><font color="black"style="font-family:宋体;">实现的产值</font></td>
            <td width="300"></td>
		    <td width="300"></td>
			<td width="300"></td>
			<td width="300"></td>
			  ...
			  <tr height="30"align="center">
		   <td width="100"><font color="black"style="font-family:宋体;">节约的成本</font></td>
            <td width="300"></td>
		    <td width="300"></td>
			<td width="300"></td>
			<td width="300"></td>
