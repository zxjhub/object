...
<table  width="1000" height="350"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="5"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>八、开放合作情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="5">&nbsp;&nbsp;&nbsp;
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="5"><font color="black"style="font-weight:bold;font-family:黑体;">表8-1  合作研发项目汇总表                                 单位：项、万元</font></td>
		</tr>
		<tr height="10">
			<td colspan="5"></td>
		</tr>
		 <tr height="30" align="center" >
           <td width="200"   rowspan="2"></td>
			<td width="200"  rowspan="2" ><font color="black"style="font-family:宋体;">合同项目数</font></td>
			<td width="200"  ></td>
			<td width="200"  rowspan="2"><font color="black"style="font-family:宋体;">合同金额</font></td>
			<td width="200"  ></td>
		</tr>
		<tr height="30"align="center">
           <td width="200"><font color="black"style="font-family:宋体;">其中：当年新立项</font></td>
           
			<td width="200"><font color="black"style="font-family:宋体;">其中：当年新立项合同金额</font></td>
           ...
           <td width="200"  ><font color="black"style="font-family:宋体;">合计</font></td>
			...
			<td width="200"  ></td>
			 ...
			 <tr height="30" align="center" >
           <td width="200"  ><font color="black"style="font-family:宋体;">联合研发项目</font></td>
			<td width="200" ></td>
			<td width="200"  ></td>
			<td width="200" ></td>
			<td width="200"  ></td>
			 ...
			 <tr height="30" align="center" >
           <td width="100"  ><font color="black"style="font-family:宋体;">委托研发项目</font></td>
			<td width="300" ></td>
			<td width="300"  ></td>
			<td width="300" ></td>
			<td width="300"  ></td>
			 ...
			 <tr height="30" align="center" >
           <td width="100"  ><font color="black"style="font-family:宋体;">受托研究项目</font></td>
			<td width="300" ></td>
			<td width="300"  ></td>
			<td width="300" ></td>
			<td width="300"  ></td>
		...
		<tr height="30" align="center" >
           <td width="100"  ><font color="black"style="font-family:宋体;">引进消化吸收再创新项目</font></td>
			<td width="300" ></td>
			<td width="300"  ></td>
			<td width="300" ></td>
			<td width="300"  ></td>
