...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="7"><font color="black"style="font-weight:bold;font-family:黑体;">表8-1-3  受托研发项目明细表</font></td>
		</tr>
		<tr height="10">
			<td colspan="7"></td>
		</tr>
          ...
          <td width="300"><font color="black"style="font-family:宋体;">哪单位委托本单位进行研发(单位名称)</font></td>
