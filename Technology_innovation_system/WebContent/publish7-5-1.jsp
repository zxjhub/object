...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="6"><font color="black"style="font-weight:bold;font-family:黑体;">表7-5-1 专有技术列表</font></td>
		</tr>
		<tr height="10">
			<td colspan="6"></td>
		</tr>
          ...
          <td width="300"><font color="black"style="font-family:宋体;">取得时间</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">取得方式</font></td>
		</tr>
		  <tr height="30"align="center">
		    <td width="100"></td>
            <td width="300"></td>
