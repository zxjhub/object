...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="6"><font color="black"style="font-weight:bold;font-family:黑体;">表9-2-2  技术咨询、技术服务合同明细表</font></td>
		</tr>
		<tr height="10">
			<td colspan="6"></td>
		</tr>
          ...
          <td width="300"><font color="black"style="font-family:宋体;">提供服务单位名称（甲方）</font></td>		  
          <td width="100"><font color="black"style="font-family:宋体;">被服务单位名称（乙方）</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">分类</font></td>
