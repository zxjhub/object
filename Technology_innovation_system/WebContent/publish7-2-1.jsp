...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="12"><font color="black"style="font-weight:bold;font-family:黑体;">表 7-2-1  验收或鉴定的科学技术成果汇总表                            单位：项</font></td>
		</tr>
		<tr height="10">
			<td colspan="12"></td>
		</tr >
		  <tr height="30">
		  <th width="300" colspan="3"><font color="black"style="font-family:宋体;">合 计</font></th>
          <th width="300" colspan="3"><font color="black"style="font-family:宋体;">基础和应用基础研究</font></th>
          <th width="300" colspan="3"><font color="black"style="font-family:宋体;">技术开发成果</font></th>
          <th width="300" colspan="3"><font color="black"style="font-family:宋体;">消化吸收再创新成果</font></th>
			</tr>
		  <tr height="30"align="center">
		  <td width="300"><font color="black"style="font-family:宋体;">验收数</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">鉴定数</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">登记数</font></td>
		  <td width="300"><font color="black"style="font-family:宋体;">验收数</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">鉴定数</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">登记数</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">验收数</font></td>
