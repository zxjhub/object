...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="8"><font color="black"style="font-weight:bold;font-family:黑体;">表7-6-2  获得的重要科学技术奖项列表</font></td>
		</tr>
		<tr height="10">
			<td colspan="8"></td>
		</tr>
          ...
          <td width="300"><font color="black"style="font-family:宋体;">获奖项目名称</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">授奖部门</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">奖项级别</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">主要完成单位（及排名）</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">主要完成人（及排名）</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">授奖时间</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">主持/参与</font></td>
		</tr>
		  <tr height="30"align="center">
		    <td width="100"></td>
            <td width="300"></td>
