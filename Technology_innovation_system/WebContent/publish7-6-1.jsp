...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="10"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>七、年度研发成果产出情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="10">&nbsp;&nbsp;&nbsp;
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="10"><font color="black"style="font-weight:bold;font-family:黑体;">表7-6-1  获得的科学技术奖项汇总表          单位：项</font></td>
		</tr>
		<tr height="10">
			<td colspan="10"></td>
		</tr>
		  <tr height="30"align="center">
		  <th width="100"><font color="black"style="font-family:宋体;">级别</font></th>
          <th width="300" colspan="2"><font color="black"style="font-family:宋体;" >奖项</font></th>
          <th width="300"><font color="black"style="font-family:宋体;">数值</font></th>
          <th width="300"><font color="black"style="font-family:宋体;">合计</font></th>
          <th width="300"><font color="black"style="font-family:宋体;">级别</font></th>
          <th width="300"colspan="2"><font color="black"style="font-family:宋体;">奖项</font></th>
          <th width="300"><font color="black"style="font-family:宋体;">数值</font></th>
          <th width="300"><font color="black"style="font-family:宋体;">合计</font></th>
		</tr>
		  <tr height="30"align="center">
		    <th width="100" rowspan="7"><font color="black"style="font-family:宋体;">国家级</font></th>
            <td width="300" colspan="2"><font color="black"style="font-family:宋体;">最高科学技术奖</font></td>
		    <td width="300"></td>
			<td width="300" rowspan="7"></td>
			<th width="300" rowspan="10"><font color="black"style="font-family:宋体;">市级</font></th>
			<td width="300" colspan="2"><font color="black"style="font-family:宋体;">突出贡献奖</font></td>
			<td width="300"></td>
			<td width="300"rowspan="10"></td>
		</tr>
		  <tr height="30"align="center">
		    <td width="100" rowspan="2"><font color="black"style="font-family:宋体;">自然科学奖</font></td>
            <td width="300" ><font color="black"style="font-family:宋体;">一等奖</font></td>
		    <td width="300"></td>
			<td width="100" rowspan="3"><font color="black"style="font-family:宋体;">自然科学奖</font></td>
			<td width="300" ><font color="black"style="font-family:宋体;">一等奖</font></td>
			<td width="300" ></td>
		</tr>
		  <tr height="30"align="center">	   
            <td width="300" ><font color="black"style="font-family:宋体;">二等奖</font></td>
		    <td width="300"></td>
			<td width="300" ><font color="black"style="font-family:宋体;">二等奖</font></td>
			<td width="300" ></td>
		</tr>
		<tr height="30"align="center">
		    <td width="100" rowspan="2"><font color="black"style="font-family:宋体;">技术发明奖</font></td>
            <td width="300" ><font color="black"style="font-family:宋体;">一等奖</font></td>
		    <td width="300"></td>
			<td width="300" ><font color="black"style="font-family:宋体;">三等奖</font></td>
			<td width="300" ></td>
		</tr>
		<tr height="30"align="center">
		    <td width="300" ><font color="black"style="font-family:宋体;">二等奖</font></td>
            <td width="300" ></td>
		    <td width="100" rowspan="3"><font color="black"style="font-family:宋体;">技术发明奖</font></td>
			<td width="300" ><font color="black"style="font-family:宋体;">一等奖</font></td>
			<td width="300" ></td>
		</tr>
		<tr height="30"align="center">
		    <td width="300" rowspan="2"><font color="black"style="font-family:宋体;">科学技术进步奖</font></td>
            <td width="300" ><font color="black"style="font-family:宋体;">一等奖</font></td>
            <td width="300" ></td>
			<td width="300" ><font color="black"style="font-family:宋体;">二等奖</font></td>
			<td width="300" ></td>
		...
		<tr height="30"align="center">
		    <th width="300" rowspan="10"><font color="black"style="font-family:宋体;">省 级</font></th>
            <td width="300" colspan="2"><font color="black"style="font-family:宋体;">突出贡献奖</font></td>
            <td width="300" ></td>
            <td width="300" rowspan="10"></td>
			<td width="300" rowspan="3"><font color="black"style="font-family:宋体;">科学技术进步奖</font></td>
			<td width="300" ><font color="black"style="font-family:宋体;">一等奖</font></td>
			<td width="300" ></td>
		</tr>
		<tr height="30"align="center">
		    <td width="300" rowspan="3"><font color="black"style="font-family:宋体;">自然科学奖</font></td>
            <td width="300" ><font color="black"style="font-family:宋体;">一等奖</font></td>
            <td width="300" ></td>
			<td width="300" ><font color="black"style="font-family:宋体;">二等奖</font></td>
			<td width="300" ></td>
		...
		<tr height="30"align="center">
		    <td width="300" ><font color="black"style="font-family:宋体;">三等奖</font></td>
            <td width="300" ></td>
			<td width="300" rowspan="7" colspan="3"><font color="black"style="font-family:宋体;">其他</font></td>
			<td width="300" rowspan="7"></td>
			<td width="300" rowspan="7">--</td>
		</tr>
		<tr height="30"align="center">	   
            <td width="300" rowspan="3"><font color="black"style="font-family:宋体;">技术发明奖</font></td>
			<td width="300" ><font color="black"style="font-family:宋体;">一等奖</font></td>
			<td width="300" ></td>
		</tr>
		<tr height="30"align="center">
