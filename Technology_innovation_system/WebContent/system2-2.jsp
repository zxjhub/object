...
<%
	...
	<%} %>
<form action="/Technology_innovation_system/SystemServlet?method=add2" method="post" onsubmit="return check()">
<table width="1000" height="240"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="2"><font color="black"style="font-weight:bold;font-family:黑体;">表2-2平台内设机构（按建设方案确定的内设工作机构填写，不包括检验检测机构和中试生产线）</font></td>
		</tr>
		<tr height="10">
			<td colspan="2"></td>
		</tr>
		 <tr height="20" align="center" >
			<td width="300"><font color="black"style="font-family:宋体;">机构名称</font></td>
			<td width="220"><font color="black"style="font-family:宋体;">操作</font></td>
		</tr>
		  <tr height="30" align="center">
			<td width="300"><input type="text" id="jgmc" name="jgmc"></td>
