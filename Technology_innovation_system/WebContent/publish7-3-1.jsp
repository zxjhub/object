...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="16"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>七、年度研发成果产出情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="16">&nbsp;&nbsp;&nbsp;
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="16"><font color="black"style="font-weight:bold;font-family:黑体;">表7-3-1 知识产权汇总表                                            单位：项</font></td>
		</tr>
		<tr height="10">
			<td colspan="16"></td>
		</tr >
		  <tr height="30">
		  <th width="300" colspan="2"><font color="black"style="font-family:宋体;">合 计</font></th>
          <th width="300" colspan="2"><font color="black"style="font-family:宋体;">发明专利</font></th>
          <th width="300" colspan="2"><font color="black"style="font-family:宋体;">实用新型</font></th>
          <th width="300" colspan="2"><font color="black"style="font-family:宋体;">外观设计</font></th>
          <th width="300" colspan="2"><font color="black"style="font-family:宋体;">植物新品种保护权</font></th>
          <th width="300" colspan="2"><font color="black"style="font-family:宋体;">软件著作权</font></th>
          <th width="300" colspan="2"><font color="black"style="font-family:宋体;">集成电路布图设计权</font></th>
          <th width="300" colspan="2"><font color="black"style="font-family:宋体;">专利的国际应用</font></th>
			</tr>
		  <tr height="30"align="center">
		  <td width="300"><font color="black"style="font-family:宋体;">申请总数</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">授权总数</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">申请总数</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">授权总数</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">申请总数</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">授权总数</font></td>          
