...
<%
	...
	<%} %>
<form action="/Technology_innovation_system/SystemServlet?method=add4" method="post" onsubmit="return check()">
<table width="1000" height="240"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="4"><font color="black"style="font-weight:bold;font-family:黑体;">表2-4  中试生产线（基地）</font></td>
		</tr>
		<tr height="10">
			<td colspan="4"></td>
		</tr>
		 <tr height="30" align="center" >
			<td width="300"><font color="black"style="font-family:宋体;">中试生产线(基地)名称</font></td>
			<td width="300"><font color="black"style="font-family:宋体;">所在单位</font></td>
			<td width="220"><font color="black"style="font-family:宋体;">操作</font></td>
		</tr>
		  <tr height="30" align="center">
			<td width="350"><input type="text" id="scxmc" name="scxmc"></td>
			<td width="350"><input type="text" id="szdw" name="szdw"></td>
			<td width="200"><input type="submit" value="添加并保存"style="width:90px; height:30px;border-radius:3px">
