...
<table  width="1170" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="8"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>三、人员情况</font></td>
		</tr>
		<tr height="40">
		...
		<tr height="55" bgcolor="#CCCCFF">
			<td colspan="8"><font color="black"style="font-weight:bold;font-family:黑体;">表3-7  现有固定人员、流动人员中高层次人才汇总表                   单位：人</font></td>
		</tr>
		<tr height="10">
			<td colspan="8"></td>
		</tr>
		 <tr height="55px" align="center" >
           <td width="90"><font color="black"style="font-family:宋体;">指标</font></td>
			<td width="90"><font color="black"style="font-family:宋体;">院士</font></td>
			<td width="90"><font color="black"style="font-family:宋体;">千人计划</font></td>
			<td width="90"><font color="black"style="font-family:宋体;">万人计划</font></td>
			 <td width="90"><font color="black"style="font-family:宋体;">长江学者</font></td>
			<td width="90"><font color="black"style="font-family:宋体;">国家杰出青年</font></td>
			<td width="90"><font color="black"style="font-family:宋体;">其他国家级称号</font></td>
			<td width="90"><font color="black"style="font-family:宋体;">省级称号</font></td>
					
		</tr>
		  <tr height="55px" align="center" >
           <td width="90"><font color="black"style="font-family:宋体;">合 计</font></td>
			<td width="90"></td>
			<td width="90"></td>
			<td width="90"></td>
			<td width="90"></td>
		 ...
		 <tr height="55px" align="center" >
           <td width="90"><font color="black"style="font-family:宋体;">固定人员</font></td>
			<td width="90"></td>
			<td width="90"></td>
			<td width="90"></td>
			<td width="90"></td>
		 ...
		 <tr height="55px" align="center" >
           <td width="90"><font color="black"style="font-family:宋体;">流动人员</font></td>
			<td width="90"></td>
			<td width="90"></td>
			<td width="90"></td>
			<td width="90"></td>
