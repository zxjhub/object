...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="8"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>八、开放合作情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="8">&nbsp;&nbsp;&nbsp;
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="8"><font color="black"style="font-weight:bold;font-family:黑体;">表8-1-1  联合研发项目明细表</font></td>
		</tr>
		<tr height="10">
			<td colspan="8"></td>
		</tr>
          ...
          <td width="300"><font color="black"style="font-family:宋体;">承担单位</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">合作单位</font></td>
