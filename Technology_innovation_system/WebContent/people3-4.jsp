...
<%
	...
	<%} %>
<form action="/Technology_innovation_system/PeopleServlet?method=add4" method="post" onsubmit="return check()">
<table  width="1170" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="11"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>三、人员情况</font></td>
		</tr>
		<tr height="40">
		<td colspan="11">&nbsp;&nbsp;&nbsp;<input type="button" value="表3-1"style="width:100px; height:35px;border-radius:3px"onclick="window.location.href= 'http://localhost:8080/Technology_innovation_system/people.jsp'">
		...
		<tr height="55" bgcolor="#CCCCFF">
			<td colspan="11"><font color="black"style="font-weight:bold;font-family:黑体;">表3-4年内减少人员列表</font></td>
		</tr>
		<tr height="10">
			<td colspan="11"></td>
		</tr>
