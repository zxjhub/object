...
<table  width="1000" height="350"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="5"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>四、科研用房和仪器设备</font></td>
		</tr>
		<tr height="40">
			<td colspan="5">&nbsp;&nbsp;&nbsp;<input type="button" value="表4-1"style="width:100px; height:35px;border-radius:3px"onclick="window.location.href= 'http://localhost:8080/Technology_innovation_system/equipment.jsp'">
			<input type="button" value="表4-2"style="width:100px; height:35px;border-radius:3px"onclick="window.location.href= 'http://localhost:8080/Technology_innovation_system/equipment4-2.jsp'">
			</td>
		</tr>
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="5"><font color="black"style="font-weight:bold;font-family:黑体;">表4-2  仪器设备</font></td>
		</tr>
		<tr height="10">
			<td colspan="5"></td>
		</tr>
		 <tr height="30" align="center" >
           <td width="200"   rowspan="2"><font color="black"style="font-family:宋体;">指标</font></td>
			<td width="200"  rowspan="2"></td>
			<td width="200"  ><font color="black"style="font-family:宋体;">仪器设备（台/套数</font></td>
			<td width="200"  rowspan="2"></td>
			<td width="200"  ><font color="black"style="font-family:宋体;">原值（万元）</font></td>
		</tr>
		<tr height="30"align="center">
           <td width="200"><font color="black"style="font-family:宋体;">其中：20万元以上仪器设备</font></td>
			<td width="200"><font color="black"style="font-family:宋体;">其中：20万元以上仪器设备</font></td>

		</tr>
			 <tr height="30" align="center" >
           <td width="200"  ><font color="black"style="font-family:宋体;">年末总数</font></td>
			<td width="200" ></td>
			<td width="200"  ></td>
			<td width="200" ></td>
			<td width="200"  ></td>
			 ...
			 <tr height="30" align="center" >
           <td width="200"  ><font color="black"style="font-family:宋体;">本年增加</font></td>
			<td width="200" ></td>
			<td width="200"  ></td>
			<td width="200" ></td>
			<td width="200"  ></td>
