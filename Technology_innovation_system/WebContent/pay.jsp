...
<table  width="1000" height="350"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="6"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>五、年度经费筹集和支出情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="6">&nbsp;&nbsp;&nbsp;
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="5"><font color="black"style="font-weight:bold;font-family:黑体;">表5-1经费筹集汇总表     单位：万元</font></td>
		</tr>
		<tr height="20">
			<td colspan="6"></td>
		</tr>
		 <tr height="30" align="center" >
           <td width="200"><font color="black"style="font-family:宋体;">经费筹集总额</font></td>
			<td width="200"><font color="black"style="font-family:宋体;">政府资金</font></td>
			<td width="200"><font color="black"style="font-family:宋体;">依托单位投入</font></td>
			<td width="200"><font color="black"style="font-family:宋体;">共建单位投入</font></td>
			<td width="200"><font color="black"style="font-family:宋体;">对外经营服务收入</font></td>
		</tr>
	
<c:forEach items="${P}" var="item">
					<tr height="30">
					<td width="200">${item.xj3}</td>
					<td width="200"></td>
					<td width="200"></td>
					<td width="200"></td>
					<td width="200"><td>
			...
			<tr height="110">
           <td colspan="6"><font size="3" color="blue"style="font-family:宋体;">注：1.“经费筹集汇总” 由财政资金，依托单位投入、共建单位投入和对外经营服务收入四部分组成；<br><br><br></font>
           <font size="3" color="black"style="font-family:宋体;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本表由“表5-2”和“表5-3”自动汇总生成，不需要填报。</font></td>
		</tr>
