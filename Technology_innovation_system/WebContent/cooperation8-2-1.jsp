...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="5"><font color="black"style="font-weight:bold;font-family:黑体;">表8-2-1  主办、承办学术（技术）会议汇总表                         单位：次  </font></td>
		</tr>
		<tr height="10">
			<td colspan="5"></td>
		</tr>
		  <tr height="30"align="center">
		  <td width="100"><font color="black"style="font-family:宋体;">合  计</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">国际</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">全国</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">国内区域</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">省内</font></td>
