...
<%
	...
	<%} %>
<form action="/Technology_innovation_system/SystemServlet?method=add5" method="post" onsubmit="return check()">
<table width="1000" height="240"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="4"><font color="black"style="font-weight:bold;font-family:黑体;">表2-5  可向社会提供的特色服务</font></td>
		</tr>
		<tr height="10">
			<td colspan="4"></td>
		</tr>
		 <tr height="30" align="center" >
			<td width="300"><font color="black"style="font-family:宋体;">服务项目</font></td>
			<td width="300"><font color="black"style="font-family:宋体;">服务内容(限50字以内)</font></td>
			<td width="220"><font color="black"style="font-family:宋体;">操作</font></td>
		</tr>
		  <tr height="30" align="center">
			<td width="350"><input type="text"id="fwxm" name="fwxm"></td>
			<td width="350"><input type="text"id="fwnr" name="fwnr"></td>
...
<script type="text/javascript">
		function check() {
			var fwxm = document.getElementById("fwxm");
			var fwnr = document.getElementById("fwnr");
			//非空
			if(fwxm.value == '') {
				alert('未填入服务项目');
				fwxm.focus();
