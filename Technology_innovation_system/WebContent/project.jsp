...
<table  width="1000" height="700"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="6"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>六、年度研发项目情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="6">&nbsp;&nbsp;&nbsp;<input type="button" value="表6-1"style="width:100px; height:35px;border-radius:3px"onclick="window.location.href= 'http://localhost:8080/Technology_innovation_system/project.jsp'">
			<input type="button" value="表6-2"style="width:100px; height:35px;border-radius:3px"onclick="window.location.href= 'http://localhost:8080/Technology_innovation_system/project6-2.jsp'">
			</td>
		</tr>
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="6"><font color="black"style="font-weight:bold;font-family:黑体;">表6-1  在研项目汇总表 单位：项，万元</font></td>
		</tr>
		<tr height="10">
			<td colspan="6"></td>
		</tr>
		 <tr height="30" align="center" >
           <td width="200" colspan="2"  rowspan="2" ></td>
			<td width="200"  colspan="2" >在研项目数</td>
			<td width="200"  colspan="2"><font color="black"style="font-family:宋体;">在研项目金额</font></td>
		</tr>
		<tr height="30"align="center">
		   <td width="200"></td>
           <td width="200"><font color="black"style="font-family:宋体;">其中：当年新列项</font></td>
           <td width="200"></td>
			<td width="200"><font color="black"style="font-family:宋体;">其中：当年新列项</font></td>
		</tr>
			<tr height="30" align="center" >
           <td width="200"  colspan="2"><font color="black"style="font-family:宋体;">合计</font></td>
			<td width="200" ></td>
			<td width="200" ></td>
			<td width="200" ></td>
			<td width="200" ></td>
           ...
           <td width="200"  rowspan="4"><font color="black"style="font-family:宋体;">政府项目</font></td>
			<td width="200">
			<p><font color="black"style="font-family:宋体;">国家级</font></p>
			<font color="black"style="font-family:宋体;">省级</font>
			</td>
			<td width="200"  >
		...
		<tr height="20" align="center" >
			<td width="200">
			<font color="black"style="font-family:宋体;">市级</font>
			</td>
			<td width="200"  >
			    <input type="text" name=" ">
			</td>
		...
		<tr height="20" align="center" >
			<td width="200">
			<font color="black"style="font-family:宋体;">县级</font>
			</td>
			<td width="200"  >
			    <input type="text" name=" ">
			</td>
		...
		<tr height="20" align="center" >
			<td width="200">
			<font color="black"style="font-family:宋体;">小计</font></td>
			<td width="200"></td>
			<td width="200" ></td>
			<td width="200" ></td>
			<td width="200" ></td>
		...
		<tr height="30" align="center" >
           <td width="200"  colspan="2"><font color="black"style="font-family:宋体;">自选项目</font></td>
			<td width="200"  ><input type="text" name=" ">
			</td>
			<td width="200" ><input type="text" name=" ">
			    </td>
			<td width="200"  > <input type="text" name=" ">
		...
		<tr height="30" align="center" >
           <td width="200"  colspan="2"><font color="black"style="font-family:宋体;">受托项目</font></td>
			<td width="200"  ><input type="text" name=" ">
			</td>
			<td width="200" ><input type="text" name=" ">
			    </td>
