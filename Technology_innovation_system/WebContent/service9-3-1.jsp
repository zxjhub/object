...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
		...
		<tr height="10">
          ...
          <td width="100"><font color="black"style="font-family:宋体;">次数</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">内容（限50字以内）</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">金额（万元）</font></td>
