...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="5"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>十、人才培养情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="5">&nbsp;&nbsp;&nbsp;<input type="button" value="表10-1"style="width:100px; height:35px;border-radius:3px"onclick="window.location.href= 'http://localhost:8080/Technology_innovation_system/train.jsp'">
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="5"><font color="black"style="font-weight:bold;font-family:黑体;">表10-1  现有人才联合培养机构</font></td>
		</tr>
		<tr height="10">
			<td colspan="5"></td>
		</tr>
		 <tr height="30" align="center" >
           <td width="100"><font color="black"style="font-family:宋体;">序号</font></td>
			<td width="300"><font color="black"style="font-family:宋体;">类别</font></td>
			<td width="300"><font color="black"style="font-family:宋体;">名称</font></td>
			<td width="300"><font color="black"style="font-family:宋体;">成立时间</font></td>
			<td width="300"><font color="black"style="font-family:宋体;">联建单位</font></td>
		</tr>
		  <tr height="30"align="center">
           <td width="100"></td>
			<td width="300"></td>
