...
<%
	...
	<%} %>
<form action="/Technology_innovation_system/SystemServlet?method=add3" method="post" onsubmit="return check()">
<table width="1000" height="240"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="5"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>二、主要研究方向和体系结构</font></td>
		</tr>
		<tr height="40">
		   <td colspan="5">&nbsp;&nbsp;&nbsp;
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="5"><font color="black"style="font-weight:bold;font-family:黑体;">表2-3检验检测机构</font></td>
		</tr>
		<tr height="10">
			<td colspan="5"></td>
		</tr>
		 <tr height="30" align="center" >
			<td width="225"><font color="black"style="font-family:宋体;">机构名称</font></td>
			<td width="225"><font color="black"style="font-family:宋体;">资质等级</font></td>
			<td width="225"><font color="black"style="font-family:宋体;">资质评定部门</font></td>
			<td width="225"><font color="black"style="font-family:宋体;">操作</font></td>
		</tr>
		  <tr height="30" align="center">
			<td width="225"><input type="text" id="jgmc" name="jgmc"></td>
			<td width="225"><input type="text"id="zzdj" name="zzdj"></td>
			<td width="225"><input type="text"id="pdbm" name="pdbm"></td>
			<td width="225"><input type="submit" value="添加并保存"style="width:90px; height:30px;border-radius:3px">
...
<script type="text/javascript">
		function check() {
			...
			var zzdj = document.getElementById("zzdj");
			var pdbm = document.getElementById("pdbm");
			//非空
			if(jgmc.value == '') {
				alert('未填入机构名称');
				jgmc.focus();
