...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="12"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>七、年度研发成果产出情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="12">&nbsp;&nbsp;&nbsp;
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="12"><font color="black"style="font-weight:bold;font-family:黑体;">表7-1-3  发表的重要论文列表（限10篇）</font></td>
		</tr>
		<tr height="10">
			<td colspan="12"></td>
		</tr>
		  <tr height="30"align="center">
		  <td width="300"><font color="black"style="font-family:宋体;">序号</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">论文题目</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">发表时间</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">作者姓名（位次）</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">刊物名称</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">年、卷、期、页</font></td>
            <td width="300"><font color="black"style="font-family:宋体;">期刊类别</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">国际索引SCI</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">国际索引EI</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">国际索引ISTP</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">他引次数</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">影响因子</font></td>
		</tr>
		  <tr height="30"align="center">
		    <td width="300"></td>
            <td width="100"></td>
