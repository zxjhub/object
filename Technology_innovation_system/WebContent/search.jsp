...
<form action="/Technology_innovation_system/SearchServlet?method=search" method="post" onsubmit="return check()">
<table  width="1000" height="90"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="7"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>调查表查看<i class="my-icon nav-icon icon_5"></i>调查表查看</font></td>
		</tr>
		 <tr height="4">
        </tr>
        <tr bgcolor="#CCCCCC" height="30">
        <td colspan="7"> <select id="search" name="search" style="width:150px;height:25px">
			<option value="ptmc">平台名称</option>
			<option value="pzrq">调查年度</option>
			<option value="tbr">填表人</option>
			</select>
          <input type="text" id="content"name="content"> <input type="submit" value="搜索"style="width:60px; height:25px;border-radius:3px"></td>       
        </tr>
        <tr height="10">
        </tr>
        <tr height="30" align="center">
        <td><font color="black"style="font-family:宋体;">平台名称</font></td>
        <td><font color="black"style="font-family:宋体;">调查年度</font></td>
        <td><font color="black"style="font-family:宋体;">填表人</font></td>
        <td><font color="black"style="font-family:宋体;">填报时间</font></td>
        <td><font color="black"style="font-family:宋体;">当前状态</font></td>
        <td><font color="black"style="font-family:宋体;">审核进度</font></td>
        </tr>
