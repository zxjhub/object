...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="6"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>七、年度研发成果产出情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="6">&nbsp;&nbsp;&nbsp;
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="6"><font color="black"style="font-weight:bold;font-family:黑体;">表7-2-2  验收或鉴定的重要科学技术成果列表</font></td>
		</tr>
		<tr height="10">
			<td colspan="6"></td>
		</tr>
          ...
          <td width="300"><font color="black"style="font-family:宋体;">成果名称</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">成果类型</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">完成单位</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">主要完成人</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">成果取得时间</font></td>
		</tr>
		  <tr height="30"align="center">
		    <td width="300"></td>
            <td width="300"></td>
