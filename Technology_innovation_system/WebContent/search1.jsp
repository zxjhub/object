...
<table  width="1000" height="90"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="7"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>调查表查看<i class="my-icon nav-icon icon_5"></i>全文检索</font></td>
		</tr>
          <tr align="center" >
         <td colspan="7"> <input type="text" id="content"name="content"style="width:200px; height:25px;"> <input type="submit" value="检索"style="width:60px; height:25px;border-radius:3px"></td>
          </tr>   
                  <tr height="10">
                  <%
...
%>
        ...
        <td><font color="black"style="font-family:宋体;">所在部门</font></td>
