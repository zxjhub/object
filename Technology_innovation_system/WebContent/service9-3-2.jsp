...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
        <tr bgcolor="#CCFFFF" height="30">
			<td colspan="6"><font color="grey">&nbsp;&nbsp;&nbsp;当前位置<i class="my-icon nav-icon icon_5"></i>统计表填报<i class="my-icon nav-icon icon_5"></i>九、成果转化和对外服务情况</font></td>
		</tr>
		<tr height="40">
			<td colspan="6">&nbsp;&nbsp;&nbsp;
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="6"><font color="black"style="font-weight:bold;font-family:黑体;">表9-3-1  技术推广项目</font></td>
		</tr>
		<tr height="10">
			<td colspan="6"></td>
		</tr>
          ...
          <td width="300"><font color="black"style="font-family:宋体;">组织单位名称）</font></td>		  
          <td width="100"><font color="black"style="font-family:宋体;">培训次数</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">培训人数</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">培训内容（限50字以内</font></td>
