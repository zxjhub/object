...
<table  width="1000" height="300"border="1" cellspacing="0"style="border-color:#FFFFFF;margin-left:232px;">
		...
		<tr height="30" bgcolor="#CCCCFF">
			<td colspan="8"><font color="black"style="font-weight:bold;font-family:黑体;">表7-3-2  申请或授权的重要知识产权列表（限10项）                  单位：件</font></td>
		</tr>
		<tr height="10">
			<td colspan="8"></td>
		</tr>
          ...
          <td width="300"><font color="black"style="font-family:宋体;">名 称</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">类 别</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">权属单位</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">权属人</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">申请/授权</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">公告日</font></td>
          <td width="300"><font color="black"style="font-family:宋体;">证号</font></td>
		</tr>
		  <tr height="30"align="center">
		    <td width="300"></td>
            <td width="300"></td>
